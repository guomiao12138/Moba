...
#include "AbilityEditorMode.generated.h"
 ...
 */
UCLASS()
class UAbilityEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_AbilityEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UAbilityEditorMode();
	virtual ~UAbilityEditorMode();
