...
#include "AbilityInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UAbilityInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UAbilityInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UAbilityInteractiveTool* NewTool = NewObject<UAbilityInteractiveTool>(SceneState.ToolManager);
...
UAbilityInteractiveToolProperties::UAbilityInteractiveToolProperties()
{
...
void UAbilityInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UAbilityInteractiveTool::Setup()
{
	...
	Properties = NewObject<UAbilityInteractiveToolProperties>(this, "Measurement");
...
void UAbilityInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UAbilityInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UAbilityInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UAbilityInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UAbilityInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UAbilityInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UAbilityInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UAbilityInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UAbilityInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
