...
#include "AbilityInteractiveTool.generated.h"


/**
 * Builder for UAbilityInteractiveTool
 */
UCLASS()
class ABILITY_API UAbilityInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UAbilityInteractiveTool
 */
UCLASS(Transient)
class ABILITY_API UAbilityInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UAbilityInteractiveToolProperties();
...
/**
 * UAbilityInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ABILITY_API UAbilityInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UAbilityInteractiveToolProperties> Properties;
